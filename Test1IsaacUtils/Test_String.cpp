...
void Test_String::test_Replace_Ch_Ch() {
	{
...
void Test_String::test_Replace_Ch_Str() {
	{
		String a = "hello there is good";
		String b = "hell0 there is g00d";
		SizeL Rtn = a.Replace('o', "0");
...
void Test_String::test_Replace_Str_Ch() {
	{
...
void Test_String::test_Find_Str() {
	String a = "__Hello there Hellish";
	{
		SizeL Pos = 0;
...
void Test_String::test_RFind_Ch() {
	String a = "__Hello there Hellish";
	{
		SizeL Pos = 0;
...
void Test_String::test_RFind_Str() {
	String a = "__Hello there Hellish";
	{
		SizeL Pos = 0;
